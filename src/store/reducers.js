...
//login
import authSlice from "../custom-store/services/authSlice";
import { authApi } from "../custom-store/services/Custom/authApi";
...
const reducer = {
  ...
  // [realstatesApi.reducerPath]: realstatesApi.reducer,
};
