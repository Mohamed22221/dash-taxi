...
const pricing2 = [
  {
    id: 1,
    type: "مكاتب",
    purpose: "سعر الاعلان الواحد",
    planIcon: "ri-book-mark-line",
    rate: 6,
    projects: 3,
    Customers: 299,
    advantages: [
      "عدد الباقات الموجوده : 2",
      "صفحه خاصه بقائمة المكاتب ( البيانات اختياريه ) ",
      "امكانيه اضافة صور المكتب تلقائيا في كل الاعلانات" ,
      "مدة كل اعلان 30 يوم"
    ],
    FTP: 5,
    supportClass: "danger",
  ...
  },
  {
    ...
    advantages: [
        "عدد الباقات الموجوده : 2",
       " تثبيت اعلانك 7 ايام في نتائج البحث",
        "تمييز اعلانك بلون الاحمر وعلامة مميزه" ,
        "مدة كل اعلان 30 يوم"
      ],
    FTP: 12,
    supportClass: "success",
  ...
  },
  {
    ...
    advantages: [
        "يتم ترحيل عدد الاعلانات في حاله عدم استخدام الابقه",
        "مدة كل اعلان 30 يوم",
