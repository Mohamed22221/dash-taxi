                                    ...
                                    <Row className="justify-content-center g-0">
                                        ...
                                        <Col lg={6}>
                                            <div className="p-lg-5 p-4">
                                                <h5 className="text-primary">أنشئ كلمة مرور جديدة</h5>
                                                <p className="text-muted">يجب أن تكون كلمة المرور الجديدة مختلفة عن كلمة المرور المستخدمة سابقًا.</p>
                                                ...
                                                <div className="p-2">
                                                    <Form onSubmit={validation.handleSubmit} action="/auth-signin-basic">
                                                        <div className="mb-3">
                                                            ...
                                                            <div id="passwordInput" className="form-text">يجب ألا يقل عن 8 أحرف.</div>
                                                        </div>

                                                        <div className="mb-3">
                                                            <Label className="form-label" htmlFor="confirm-password-input">تأكيد كلمة المرور</Label>
                                                        ...
                                                        <div className="form-check">
                                                            ...
                                                            <Label className="form-check-label" htmlFor="auth-remember-check">تذكرنى</Label>
                                                        </div>

                                                        <div className="mt-4">
                                                            <Button color="primary" className="w-100" type="submit">أرسل رابط إعادة التعيين</Button>
                                                        </div>
                                                    </Form>
                                                </div>

                                                <div className="mt-5 text-center">
                                                    <p className="mb-0">انتظر ، أتذكر كلمة المرور الخاصة بي ... <Link to="/auth-signin-cover" className="fw-semibold text-primary text-decoration-underline"> انقر هنا </Link> </p>
                                                </div>
                                            </div>
                                        </Col>
                                        <AuthSlider />
