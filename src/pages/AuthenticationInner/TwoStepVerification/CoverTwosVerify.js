...
const CoverTwosVerify = () => {
    document.title = "Two Step Verification | Easymedia";
                                        ...
                                        <Col lg={6}>
                                            <div className="p-lg-5 p-4">
                                                ...
                                                <div className="text-muted text-center mx-lg-3">
                                                    <h4 className="">قم بتأكيد بريدك الألكتروني</h4>
                                                    <p>الرجاء إدخال الرمز المكون من 4 أرقام المرسل إلى<span className="fw-semibold">example@abc.com</span></p>
                                                </div>
                                                ...
                                                <div className="mt-4">
                                                    <form>
                                                        ...
                                                        <div className="mt-3">
                                                            <Button color="primary" className="w-100" onClick={() => navigate("/auth-success-msg-cover")}>تأكيد</Button>
                                                        </div>
                                                ...
                                                <div className="mt-5 text-center">
                                                    <p className="mb-0">لم تتلق رمز؟ <Link to="/auth-pass-reset-cover" className="fw-semibold text-primary text-decoration-underline">إعادة إرسال</Link> </p>
                                                </div>
                                            </div>
                                        </Col>
                                        <AuthSlider />
